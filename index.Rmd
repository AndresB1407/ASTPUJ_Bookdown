--- 
title: "Análisis de Serie de Tiempo S&P 500"
author: "Jesús Andrés Burbano Gómez"
date: "`r Sys.Date()`"
...
```{r scatter plot1, include=TRUE, warning=FALSE, message=FALSE, echo=TRUE, fig.width=7, fig.height=5}
...
```{r ts graph 1 1, include=TRUE, warning=FALSE, message=FALSE, echo=TRUE, dev='png', fig.width=7, fig.height=5}
...
```{r lagplot1, include=TRUE, warning=FALSE, message=FALSE, echo=TRUE, dev='png',fig.width=7, fig.height=5}
...
```{r seasonality1, include=TRUE, warning=FALSE, message=FALSE, echo=TRUE, dev='png',fig.width=7, fig.height=5}
...
```{r MA1, include=TRUE, warning=FALSE, message=FALSE, echo=TRUE, dev='png',fig.width=7, fig.height=5}
...
```{r lagged1, include=TRUE, warning=FALSE, message=FALSE, echo=TRUE, dev='png',fig.width=7, fig.height=5}
